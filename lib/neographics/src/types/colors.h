...
#define n_GColorOxfordBlueARGB8            ((uint8_t)   0b11000010)
#define n_GColorOxfordBlue                 ((n_GColor) { .argb = (n_GColorOxfordBlueARGB8) })

#define n_GColorDarkBlueARGB8              ((uint8_t)   0b11000001)
...
#define n_GColorMalachiteARGB8             ((uint8_t)   0b11001110)
#define n_GColorMalachite                  ((n_GColor) { .argb = (n_GColorMalachiteARGB8) })

#define n_GColorMediumSpringGreenARGB8     ((uint8_t)   0b11001101)
...
#define n_GColorFollyARGB8                 ((uint8_t)   0b11110010)
#define n_GColorFolly                      ((n_GColor) { .argb = (n_GColorFollyARGB8) })

#define n_GColorFashionMagentaARGB8        ((uint8_t)   0b11110001)
...
#define n_GColorIcterineARGB8              ((uint8_t)   0b11111110)
#define n_GColorIcterine                   ((n_GColor) { .argb = (n_GColorIcterineARGB8) })

#define n_GColorPastelYellowARGB8          ((uint8_t)   0b11111101)
