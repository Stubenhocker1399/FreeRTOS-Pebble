...
static void test_window_load(Window *window)
{
    ...
    // Setup the view
    Layer *test_main_layer = layer_create(bounds);
    layer_add_child(window_layer, test_main_layer);
    ...
    layer_add_child(test_main_layer, status_bar_layer_get_layer(status_bar));
}
